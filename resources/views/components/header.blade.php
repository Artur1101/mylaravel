    ...
    <div class="menu-mobile-left-content menu-bg-white">
        <ul>
            ...
            <li><a href="#"><img src="img/icon_mobile_gray.png" alt="Icon Mobile & Tablet" />
                    <p>Мобильный телефон и планшет</p>
                </a></li>
        ...
        <header class="relative full-width">
                ...
                <div class=" container">
                    <div class="row">
                        <div class=" header-top">
                            <p class="contact_us_header col-md-4 col-xs-12 col-sm-3 clear-margin">
                                <img src="img/icon_phone_top.png" alt="Icon Phone Top Header"> Позвоните нам <span
                                    class="text-red bold">+7900-900-00 00</span>
                            </p>
                        ...
                        <div class="clearfix header-content full-width relative">
                            ...
                            <div class="cart-detail-header border">
                                <div class="relative">
                                    <div class="product-cart-son clearfix">
                                        <div class="image-product-cart float-left center-vertical-image ">
                                            <a href="#"><img src="img/product_image_6-min.png"
                                                    alt=""></a>
                                        </div>
                                    ...
                                    <div class="product-cart-son">
                                        <div class="image-product-cart float-left center-vertical-image">
                                            <a href="#"><img src="img/product_image_7-min.png"
                                                    alt=""></a>
                                        </div>
                                        <div class="info-product-cart float-left">
                                            <p class="title-product title-hover-black"><a class="animate-default"
                                                    href="#">Сумка для йоги Voyage</a></p>
                                            <p class="clearfix price-product">$350 <span
                                                    class="total-product-cart-son">(x1)</span></p>
                                        </div>
                                    </div>
                                ...
                                <div class="relative btn-cart-header">
                                    ...
                                    <a href="#"
                                        class="uppercase bold button-hover-red animate-default">Проверить</a>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <a class="menu-vertical hidden-md hidden-lg" onclick="showMenuMobie()">
                            <span class="animate-default"><i class="fa fa-list" aria-hidden="true"></i> Все
                                категории</span>
                        </a>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="menu-header full-width">
                            <ul class="clear-margin">
                                <li onclick="showMenuHomeV3()"><a class="animate-default" href="#"><i
                                            class="fa fa-list" aria-hidden="true"></i> Все категории</a></li>
            ...
            <div class="clearfix menu_more_header menu-web menu-bg-white">
                <ul>
                    ...
                    <li><a href="#"><img src="img/icon_computer_gray.png"
