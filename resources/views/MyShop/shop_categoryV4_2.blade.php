			...
			<div class="container">
				<div class="row">
					<div class="breadcrumb-web">
						<ul class="clear-margin">
							<li class="title-hover-red animate-default"><a href="#">Дом</a></li>
							<li class="title-hover-red animate-default"><a href="#">Все продукты</a></li>
						</ul>
					</div>
				</div>
			</div>
						...
						<div class="relative clearfix">
							<div class="col-md-12 clear-padding border no-border-t no-border-l no-border-r product-category bottom-margin-default product-category-list relative">
								...
								<div class="relative overfollow-hidden info-product-list">
									...
									<p class="intro-product-category">Я ненавижу футбол. Смартфоны Морби мягкий и мудрый. Это печальная ситуация. Не бывает футбольного мяча с мягкими ногами. Нужна помощь, разработчику нужен интернет. В авторской политике.</p>
							...
							<div class="col-md-12 clear-padding border no-border-t no-border-l no-border-r product-category bottom-margin-default product-category-list relative">
								<div class="image-product relative overfollow-hidden">
									<div class="center-vertical-image">
										<img src="img/product_image_1-min.png" alt="Product">
									</div>
									<a href="#"></a>
									<ul class="option-product animate-default clear-margin">
										<li class="relative"><a href="#"><i class="data-icon data-icon-ecommerce icon-ecommerce-bag"></i></a></li>
							...
							<div class="col-md-12 clear-padding border no-border-t no-border-l no-border-r product-category bottom-margin-default product-category-list relative">
								<div class="image-product relative overfollow-hidden">
									<div class="center-vertical-image">
										<img src="img/product_image_2-min.png" alt="Product">
									</div>
									<a href="#"></a>
									<ul class="option-product animate-default clear-margin">
										<li class="relative"><a href="#"><i class="data-icon data-icon-ecommerce icon-ecommerce-bag"></i></a></li>
								...
								<div class="relative overfollow-hidden info-product-list">
									<h3 class="title-product clearfix full-width title-hover-black"><a href="#">Сумка-мессенджер Wayfarer5</a></h3>
									<div class="clearfix ranking-product-category ranking-color">
										<i class="fa fa-star" aria-hidden="true"></i>
										<i class="fa fa-star" aria-hidden="true"></i>
										<i class="fa fa-star" aria-hidden="true"></i>
							...
							<div class="col-md-12 clear-padding border no-border-t no-border-l no-border-r product-category bottom-margin-default product-category-list relative">
								<div class="image-product relative overfollow-hidden">
									<div class="center-vertical-image">
										<img src="img/product_home_18-min.png" alt="Product">
									</div>
									<a href="#"></a>
									<ul class="option-product animate-default clear-margin">
										<li class="relative"><a href="#"><i class="data-icon data-icon-ecommerce icon-ecommerce-bag"></i></a></li>
							...
							<div class="col-md-12 clear-padding border no-border-t no-border-l no-border-r product-category bottom-margin-default product-category-list relative">
								<div class="image-product relative overfollow-hidden">
									<div class="center-vertical-image">
										<img src="img/product_image_3-min.png" alt="Product">
									</div>
									<a href="#"></a>
									<ul class="option-product animate-default clear-margin">
										<li class="relative"><a href="#"><i class="data-icon data-icon-ecommerce icon-ecommerce-bag"></i></a></li>
							...
							<div class="col-md-12 clear-padding border no-border-t no-border-l no-border-r product-category bottom-margin-default product-category-list relative">
								<div class="image-product relative overfollow-hidden">
									<div class="center-vertical-image">
										<img src="img/product_image_5-min.png" alt="Product">
									</div>
									<a href="#"></a>
									<ul class="option-product animate-default clear-margin">
										<li class="relative"><a href="#"><i class="data-icon data-icon-ecommerce icon-ecommerce-bag"></i></a></li>
								...
								<div class="relative overfollow-hidden info-product-list">
									<h3 class="title-product clearfix full-width title-hover-black"><a href="#">Эмиль Генри Бразер r21</a></h3>
									<div class="clearfix ranking-product-category ranking-color">
										<i class="fa fa-star" aria-hidden="true"></i>
										<i class="fa fa-star" aria-hidden="true"></i>
										<i class="fa fa-star" aria-hidden="true"></i>
