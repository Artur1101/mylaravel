                    ...
                    <div class="row">
                        <div class=" header-top">
                            <p class="contact_us_header col-md-4 col-xs-12 col-sm-3 clear-margin">
                                <img src="img/icon_phone_top.png" alt="Icon Phone Top Header" /> Позвоните нам <span class="text-red bold">+7900-900-00 00</span>
                            </p>
				...
				<div class="row">
					<div class="breadcrumb-web">
						<ul class="clear-margin">
							...
							<li class="animate-default title-hover-red"><a href="#">404 Page</a></li>
						</ul>
					</div>
				</div>
			</div>
			...
			<div class="container">
				<div class="row relative">
					<div class=" relative content-404">
						...
						<p>ЭТО НЕ ТА СТРАНИЦА, КОТОРУЮ ВЫ ИЩЕТЕ</p>
						<div class="btn-back">
							<p>Пожалуйста, попробуйте одну из следующих страниц</p>
							<a href="#" class="animate-default button-hover-red">Домашняя страница</a>
						</div>
					</div>
				</div>
			</div>
