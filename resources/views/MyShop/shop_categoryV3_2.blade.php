						...
						<div class="relative clearfix">
							<div class="col-md-12 clear-padding border no-border-t no-border-l no-border-r product-category bottom-margin-default product-category-list relative">
								...
								<div class="relative overfollow-hidden info-product-list">
									...
									<p class="intro-product-category">Я люблю футбол. Смартфоны Морби мягкий и мудрый. Это печальная ситуация. Не бывает футбольного мяча с мягкими ногами. Нужна помощь, разработчику нужен интернет. В авторской политике оз.</p>
							...
							<div class="col-md-12 clear-padding border no-border-t no-border-l no-border-r product-category bottom-margin-default product-category-list relative">
								...
								<div class="relative overfollow-hidden info-product-list">
									...
									<p class="clearfix price-product"><span class="price-old">$700</span> $350</p>
									<p class="intro-product-category">Я ненавижу футбол. Смартфоны Морби мягкий и мудрый. Это печальная ситуация. Не бывает футбольного мяча с мягкими ногами. Нужна помощь, разработчику нужен интернет. В авторской политике оз.</p>
									<div class="relative button-product-list clearfix">
										<ul class="clear-margin">
											<li class="button-hover-red"><a href="#" class="animate-default">Добавить в корзину</a></li>
											<li><a href="#" class="animate-default"><i class="fa fa-heart" aria-hidden="true"></i></a></li>
