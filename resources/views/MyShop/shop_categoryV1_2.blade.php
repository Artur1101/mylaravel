					...
					<div class="col-md-9 relative clear-padding">
						...
						<div class="row">
							...
							<div class="col-md-4 col-sm-4 col-xs-12 product-category relative effect-hover-boxshadow animate-default">
								...
								<h3 class="title-product clearfix full-width title-hover-black"><a href="#">Полевой вестник соперника</a></h3>
								<p class="clearfix price-product"><span class="price-old">$700</span> $350</p>
								<div class="clearfix ranking-product-category ranking-color">
									<i class="fa fa-star" aria-hidden="true"></i>
									<i class="fa fa-star" aria-hidden="true"></i>
							...
							<div class="col-md-4 col-sm-4 col-xs-12 product-category relative effect-hover-boxshadow animate-default">
								...
								<h3 class="title-product clearfix full-width title-hover-black"><a href="#">Спортивная сумка</a></h3>
								<p class="clearfix price-product"><span class="price-old">$700</span> $350</p>
								<div class="clearfix ranking-product-category ranking-color">
									<i class="fa fa-star" aria-hidden="true"></i>
									<i class="fa fa-star" aria-hidden="true"></i>
							...
							<div class="col-md-4 col-sm-4 col-xs-12 product-category relative effect-hover-boxshadow animate-default">
								...
								<h3 class="title-product clearfix full-width title-hover-black"><a href="#">Эмиль Анри Брайзерr21</a></h3>
								<p class="clearfix price-product"><span class="price-old">$700</span> $350</p>
								<div class="clearfix ranking-product-category ranking-color">
									<i class="fa fa-star" aria-hidden="true"></i>
									<i class="fa fa-star" aria-hidden="true"></i>
							...
							<div class="col-md-4 col-sm-4 col-xs-12 product-category relative effect-hover-boxshadow animate-default">
								...
								<h3 class="title-product clearfix full-width title-hover-black"><a href="#">Маурис Вариус</a></h3>
								<p class="clearfix price-product"><span class="price-old">$700</span> $350</p>
								<div class="clearfix ranking-product-category ranking-color">
									<i class="fa fa-star" aria-hidden="true"></i>
									<i class="fa fa-star" aria-hidden="true"></i>
							...
							<div class="col-md-4 col-sm-4 col-xs-12 product-category relative effect-hover-boxshadow animate-default">
								...
								<h3 class="title-product clearfix full-width title-hover-black"><a href="#">Меценат просто бывший</a></h3>
								<p class="clearfix price-product"><span class="price-old">$700</span> $350</p>
								<div class="clearfix ranking-product-category ranking-color">
									<i class="fa fa-star" aria-hidden="true"></i>
									<i class="fa fa-star" aria-hidden="true"></i>
