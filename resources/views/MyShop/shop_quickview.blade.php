				...
				<div class="row ">
					...
					<div class="col-md-9 relative clear-padding">
						...
						<div class="relative clearfix">
							<div class="bar-category bottom-margin-default border no-border-r no-border-l no-border-t">
								<div class="row">
									...
									<div class="col-md-5 col-sm-5 col-xs-8 right-category-bar float-right relative">
										<p class=" float-left">Показаны 1–20 из 75 результатов</p>
							...
							<div class="col-md-4 col-sm-4 col-xs-12 product-category relative">
								...
								<h3 class="title-product clearfix full-width title-hover-black"><a href="#">Дорожная сумка для йоги</a></h3>
							...
							<div class="col-md-7 col-sm-12 col-xs-12">
								<div class="top-title-modal border no-border-l no-border-r no-border-t bottom-padding-15-default">
									...
									<div class="box-rank-modal">
										...
										<p class="count-review-modal">(4 отзыва)</p>
									</div>
								</div>
								...
								<div class="option-button-modal relative bottom-margin-default top-margin-default">
									...
									<a href="#" class="add-cart-modal left-margin-15-default animate-default">ДОБАВИТЬ В КОРЗИНУ</a>
								...
								<div class="relative category-product-modal">
									<p>Артикул : <span class="text-red">671272</span></p>
									<p>Категория : <a href="#" class="text-red">Мобильные и планшетные компьютеры</a></p>
									<p>Ярлык : <span class="text-red"><a href="#" class="text-red">iPhone</a>, <a href="#" class="text-red">Apple</a>, <a href="#" class="text-red">iPhone X</a></span></p>
								</div>
							</div>
						</div>
					</div>
