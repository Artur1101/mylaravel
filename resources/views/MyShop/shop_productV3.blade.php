						...
						<div class="slide-product-bottom relative">
							<div class="row">
								<div class="col-md-12 col-sm-12 col-xs-12 relative bottom slide-related-product">
									...
									<div class="owl-theme owl-carousel" data-items="1,2,3,4">
										<div class="items">
											<div class="full-width product-category relative">
												...
												<h3 class="title-product animate-default title-hover-black clearfix full-width"><a href="#">Рюкзак Endeavour для однодневной поездки</a></h3>
										...
										<div class="items">
											<div class="full-width product-category relative">
												...
												<h3 class="title-product animate-default title-hover-black clearfix full-width"><a href="#">MH01-Black</a></h3>
												<p class="clearfix price-product"><span class="price-old">$700</span> $350</p>
												<div class="clearfix ranking-product-category ranking-color">
													<i class="fa fa-star" aria-hidden="true"></i>
													<i class="fa fa-star" aria-hidden="true"></i>
									...
									<div class="owl-theme owl-carousel" data-items="1,2,3,4">
										<div class="items">
											<div class="full-width product-category relative">
												...
												<h3 class="title-product animate-default title-hover-black clearfix full-width"><a href="#">Полевой посланник</a></h3>
												<p class="clearfix price-product"><span class="price-old">$700</span> $350</p>
												<div class="clearfix ranking-product-category ranking-color">
													<i class="fa fa-star" aria-hidden="true"></i>
													<i class="fa fa-star" aria-hidden="true"></i>
